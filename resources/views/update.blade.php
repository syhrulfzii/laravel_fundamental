            ...
            <div class="col-6 m-auto my-5 border border-success p-3">
                ...
                <form method="POST" action="/EditProduct/{{ $product->id }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input value={{ $product->gambar }} name="gambar" type="text" class="form-control"
                            id="gambar_produk">
                    </div>
                    {{-- nama produk --}}
                    <div class="mb-3">
                        <label for="nama_produk" class="form-label fw-bold">Nama Produk</label>
                        <input value={{ $product->nama }} name="nama" type="text" class="form-control"
                            id="nama_produk">
                    </div>
                    {{-- berat --}}
                    <div class="mb-3">
                        <label for="berat_produk" class="form-label fw-bold">berat</label>
                        <input value={{ $product->berat }} name="berat" type="number" class="form-control"
                            id="berat_produk">
                    </div>
                    {{-- harga --}}
                    <div class="mb-3">
                        <label for="harga" class="form-label fw-bold">Harga</label>
                        <input value={{ $product->harga }} name="harga" type="number" class="form-control"
                            id="harga_produk">
                    </div>
                    {{-- stok --}}
                    <div class="mb-3">
                        <label for="stok" class="form-label fw-bold">Stok</label>
                        <input value={{ $product->stok }} name="stok" type="number" class="form-control"
                            id="stok">
                    </div>
